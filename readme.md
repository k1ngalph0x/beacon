...
Beacon is a distributed error tracking system inspired by tools like Sentry. It collects application events, groups them into issues, and triggers alerts based on configurable rules.
...
Services communicate asynchronously via Kafka. This allows:
